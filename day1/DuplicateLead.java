	...
	public static void main(String[] args) throws InterruptedException {
	    ...
	    st.selectByVisibleText("New York");
		 ...
		 driver.findElement(By.linkText("Duplicate Lead")).click();
 		 ...
 		 driver.findElement(By.id("createLeadForm_companyName")).sendKeys("Netwest Group");
         driver.findElement(By.id("createLeadForm_firstNamee")).clear();	
 		 driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Shahrukh");
